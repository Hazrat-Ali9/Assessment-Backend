...
#### order:  my_print_defaults mysqld datadir, C:/Program Files/MariaDB 11.0/data
####
...
sub init_log
{
  ...
  if (!defined($logdir))
  {
    $logdir= "C:/Program Files/MariaDB 11.0/data" if (-d "C:/Program Files/MariaDB 11.0/data" && -w "C:/Program Files/MariaDB 11.0/data");
  }
  if (!defined($logdir))
  {
      ...
      if ("--datadir=" eq substr($options[$j], 0, 10)) {
        ...
        if (! -d $datadir."/mysql") {
          if (-w $datadir) {
            ...
            $install_cmd="C:/Program Files/MariaDB/bin/mysql_install_db ";
...
#
#   Before using, you must create a my.cnf file either in C:/Program Files/MariaDB/my.cnf
...
[mysqld_multi]
mysqld     = C:/Program Files/MariaDB/bin/mariadbd-safe
mysqladmin = C:/Program Files/MariaDB/bin/mariadb-admin
user       = multi_admin
...
port       = 3307
pid-file   = C:/Program Files/MariaDB 11.0/data2/hostname.pid2
datadir    = C:/Program Files/MariaDB 11.0/data2
language   = C:/Program Files/MariaDB/share/mysql/english
user       = unix_user1
...
port       = 3308
pid-file   = C:/Program Files/MariaDB 11.0/data3/hostname.pid3
datadir    = C:/Program Files/MariaDB 11.0/data3
language   = C:/Program Files/MariaDB/share/mysql/swedish
user       = unix_user2

[mysqld4]
socket     = /tmp/mysql.sock4
port       = 3309
pid-file   = C:/Program Files/MariaDB 11.0/data4/hostname.pid4
datadir    = C:/Program Files/MariaDB 11.0/data4
language   = C:/Program Files/MariaDB/share/mysql/estonia
user       = unix_user3
 
[mysqld6]
socket     = /tmp/mysql.sock6
port       = 3311
pid-file   = C:/Program Files/MariaDB 11.0/data6/hostname.pid6
datadir    = C:/Program Files/MariaDB 11.0/data6
language   = C:/Program Files/MariaDB/share/mysql/japanese
user       = unix_user4
EOF
  exit(0);
}
